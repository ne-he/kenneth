...
import { Columns, HBars, Heatmap, OccupancyLine, PairedBars, SERIES } from '../components/charts/Charts'
...
const COPY = {
  id: {
    ...
    kpiPriority: 'Tiket jalur prioritas',
    at: 'jam',
    ...
    whereSub: 'Pengguna KENNETH yang dialihkan. Properti satu grup diutamakan.',
    ...
    p2d: 'Cuma laku di lokasi yang antri. Ditambah fitur ingatkan nanti dan pemerataan antrian antar gerbang.',
    p3: 'Dashboard data',
    p3p: 'Rp5-10jt / bulan',
  ...
  en: {
    ...
    kpiPriority: 'Priority entry tickets',
    at: 'at',
    ...
    whereSub: 'KENNETH users who were redirected. Same group properties first.',
    ...
    p2d: 'Only sells where there is a queue. Plus come-back-later reminders and queue spreading across gates.',
    p3: 'Data dashboard',
    p3p: 'Rp5-10m / month',
